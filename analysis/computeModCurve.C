...
void Help()
{
	cout<<" computeModulation curves from the simulation outputs"<<endl;
	cout<<"computeModulation -i <input.root>  -data <pm|pm3>  -nbang <polarization bins>  -nbpol <number of bins for polarization>"<<G4endl;
