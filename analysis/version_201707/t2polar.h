...
class t2polar {
    public :
        ...
        Int_t           coincidence[1600];   ///Trigger pattern
        ...
        Float_t   xi[NPAIRMAX]; //azimuthal angle
        int is_local_max_bar1[NPAIRMAX] ;       ///normalized adc channel
        int is_local_max_bar2[NPAIRMAX] ;       ///normalized adc channel
        ...
        TBranch        *b_coincidence;   //!
        TBranch     *b_is_local_max_bar1;
        TBranch     *b_is_local_max_bar2;
        ...
        virtual float GetAzimuthalAngle(float *data, double eth);

        void GetMaximum(float *data, float &firstmax, int &idx1, float &secmax, int &idx2);
