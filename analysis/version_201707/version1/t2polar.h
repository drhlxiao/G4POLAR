...
class t2polar {
    public :
        ...
        Float_t	  open_angle;       ///open angle
        Float_t   pair_dist1; // the distance from source to one of the coincidence hit
        Float_t   pair_dist2; // the distance from source to one of the coincidence hit
        Float_t   pair_dist; //distance between two hit pairs
