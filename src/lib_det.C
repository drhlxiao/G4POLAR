...
int get_mc_module_position(int mc)
{
	//hualin xiao 20180119
	//convert copy number to module position
	int rows=5;
	int m=mc/rows;
	int n=mc%rows;
	int pos=2*m*rows+rows-1-mc;
	return pos;
}
int get_mc_bar_position(int mc)
{
	//convert copy number to module position
	int rows=8;
	int m=mc/rows;
